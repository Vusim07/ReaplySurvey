...
<nav class="navbar navbar-expand-md">
    <div class="container-fluid">
        ...
        <a class="navbar-brand" href="<?php echo $this->createUrl("/admin/"); ?>">
            <img src="<?= Yii::app()->baseUrl ?>/assets/images/reaply_icon-white.png" height="40"
                ...
                <li class="nav-item d-flex"><a
                    ...
                    <?php if ($activesurveyscount > 0): ?>
                        <a class="nav-link ps-0 active-surveys"
                            href="<?php echo $this->createUrl('surveyAdministration/listsurveys/active/Y'); ?>"><span
                                class="badge"> <?php echo $activesurveyscount ?> </span></a>
                    <?php endif; ?>
                </li>
